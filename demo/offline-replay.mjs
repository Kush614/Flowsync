...
const server = createServer((req, res) => {
  ...
  const archMmd = read("architecture.mmd");
  const archUrl =
    (read("architecture-url.txt").split("=")[1] || "").trim() ||
    "https://www.notion.so/FlowSync-Architecture-363b98e7d08181159a26c8e44a40fbe7";
  ...
  <div class="card">
    <h2>1b · Code ⇄ Notion · Architecture diagram (renders live in Notion)</h2>
    <p class="sub" style="margin:0 0 10px">Generated from the real package graph. In Notion this Mermaid block renders as a styled diagram; <code>arch scaffold</code> turns it back into a code skeleton.</p>
    <pre>${archMmd.replace(/</g, "&lt;")}</pre>
    <div><a href="${archUrl}" target="_blank">Open the rendered diagram in Notion ↗</a></div>
  </div>
